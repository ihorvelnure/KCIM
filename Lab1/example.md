...
### Недоліки моделі:
 - велика смертність кролів, яка обумовлена тільки факторами недоїдання трави чи бур'яна
 - мала кількість факторів, які впливають на екосистему популяції кролів
 - модель гнучка, але не до кінця розвинена
